...
public class BasicChain {
    ...
    public static void main(String[] args) {
        ...
        //create genesis transaction, which sends 100 BasicCoin to walletA:
        genesisTransaction = new Transaction(binance.publicKey, walletA.publicKey, 100f, null);
        genesisTransaction.generateSignature(binance.privateKey);     //manually sign the genesis transaction
